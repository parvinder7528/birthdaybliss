        ...
        <div className="max-w-md mx-auto">
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
            <div className="bg-gradient-to-r from-pink-500 to-purple-500 p-8 text-center">
              ...
              <p className="text-white/90">Sign in to continue shopping</p>
            </div>
            <div className="p-8">
              <form className="space-y-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a
                    className="text-sm text-pink-500 hover:text-pink-600 font-semibold cursor-pointer whitespace-nowrap"
                    href="/preview/5c7a3b7b-8428-4827-9c67-1cd627e3a8d7/5185569/forgot-password"
                    data-discover="true"
                  >
                    Forgot Password?
                  </a>
